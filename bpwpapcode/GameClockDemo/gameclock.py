# This file is part of GameClockDemo.
#
# GameClockDemo is free software: you can redistribute it and/or modify it
# under the terms of the GNU Lesser General Public License as published
# by the Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.
#
# GameClockDemo is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
# GNU Lesser General Public License for more details.
#
# You should have received a copy of the GNU Lesser General Public
# License along with GameClockDemo.  If not, see /www.gnu.org/licenses/>.

# Compatible: Python 2.7, Python 3.2

"""gameclock.py - Game clock for Gummworld2.

GameClockDemo is a fixed time-step clock that keeps time in terms of game
...
GameClockDemo manages time in the following ways:
...
GameClockDemo.schedule_interval.
...
does not. The GameClockDemo class is purely Python and should be compatible with
